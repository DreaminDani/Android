...
public class OAuthExample extends Activity implements OAuthCallback { // implement the OAuthCallback interface to get the right information
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.oauth_example);
            
        final OAuth o = new OAuth(this);
        o.initialize("wi0_puckBkhSaV9sk3vAr6aPpis"); // Initialize the oauth key
        ...
        facebookButton.setOnClickListener(new View.OnClickListener() { // Listen the on click event
            ...
            {
				o.popup("facebook", OAuthExample.this); // Launch the pop up with the right provider & callback
            }
        });
        ...
        twitterButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) 
            {
				o.popup("twitter", OAuthExample.this); // Launch the pop up with the right provider & callback
            }
        });
